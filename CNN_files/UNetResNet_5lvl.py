...
def get_unet(input_img, n_filters=8, kernel_size = 3, activation = 'relu'):
    ...
    c7 = conv2d_block(u6, n_filters * 8, kernel_size, activation)
    r7 = residual_block(c7, n_filters * 8,activation, kernel_size)
    cc7 = conv2d_block(r7, n_filters * 8, kernel_size, activation)
